...
class WaitlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waitlist" do
    assert_difference('Waitlist.count') do
      post waitlists_url, params: { waitlist: { applicant: @waitlist.applicant, datetime: @waitlist.datetime, property: @waitlist.property, status: @waitlist.status } }
    end
  ...
  test "should update waitlist" do
    patch waitlist_url(@waitlist), params: { waitlist: { applicant: @waitlist.applicant, datetime: @waitlist.datetime, property: @waitlist.property, status: @waitlist.status } }
